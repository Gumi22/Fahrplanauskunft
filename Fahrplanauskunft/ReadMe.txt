========================================================================
    KONSOLENANWENDUNG: Fahrplanauskunft-Projektübersicht
========================================================================

Diese Fahrplanauskunft-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Fahrplanauskunft-Anwendung besteht.


Fahrplanauskunft.vcxproj
...
Fahrplanauskunft.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Fahrplanauskunft.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
